...
const meaning = {
  ...
  destiny: {
    "title": "Destino",
    "description": "Este es el número más influyente en relación con tus motivaciones personales, lo que te gusta y a quién te gusta tener a tu alrededor, y las carreras hacia las que tendrías más probabilidades de aspirar.",
  ...
  attitude: {
    "title": "Actitud",
    "description": "Este número es más poderoso en los primeros 30-35 años de tu vida y representa cómo y por qué reaccionas a las circunstancias en tu juventud.",
  ...
  character: {
    "title": "Carácter",
    "description": "Este número representa principalmente tus cualidades públicas y sociales, pero también exhibirías muchas de las mismas cualidades en tus relaciones personales.",
  ...
  soul: {
    ...
    "description": "Esta influencia presenta una visión de tu ser intuitivo y lleno de alma.",
  ...
  purpose:{
    ...
    "description": "Este es el número de vibración de tu propósito divino en tu despedida de actuación. Es lo que tu Ser Alma ha elegido lograr en los últimos años de tu vida.",
