...
const meaning = {
  ...
  destiny: {
    "title": "Bestimmung",
    "description": "Dies ist die einflussreichste Zahl in Bezug auf Ihre persönlichen Motivationen, das, was und wen Sie in Ihrer Umgebung mögen und die Karriere(n), die Sie am wahrscheinlichsten anstreben würden.",
  ...
  personality: {
    ...
    "description": "Diese Zahl beschreibt das hinter den Kulissen oder private Sie.",
    "func": "Tag der Geburt",
  ...
  attitude: {
    "title": "Einstellung",
    "description": "Diese Zahl ist in den ersten 30-35 Lebensjahren am stärksten und repräsentiert das Wie und Warum Ihrer Reaktionen auf Umstände in Ihrer Jugend.",
  ...
  character: {
    "title": "Charakter",
    "description": "Diese Zahl repräsentiert hauptsächlich Ihre öffentlichen und sozialen Qualitäten, aber Sie würden auch in Ihren persönlichen Beziehungen weitgehend dasselbe zeigen.",
  ...
  agenda: {
    ...
    "description": "Diese Schwingung bietet Ihre angeborenen (verborgenen) Wünsche.",
  ...
  purpose:{
    ...
    "description": "Dies ist deine Abschiedsvorstellung der Schwingungszahl. Es ist das, was dein Seelisches Selbst sich für deine späteren Lebensjahre ausgesucht hat.",
